...
bindsym $mod+b exec --no-startup-id ${I3_HOME:-~/.i3}/bin/dmenu_browse "M4_BROWSER" "M4_BROWSER_SEARCH" -i -p browse -fn "M4_I3_DMENU_FONT" -nb "M4_I3_BG" -nf "M4_COLOR_FG" -sb "M4_COLOR_6" -sf "M4_I3_ACTIVE_FG"
bindsym $mod+Shift+b exec --no-startup-id ${I3_HOME:-~/.i3}/bin/dmenu_browse "M4_BROWSER" "M4_BROWSER_SEARCH" --clip
