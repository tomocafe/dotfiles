...
bindsym $mod+x exec --no-startup-id ${I3_HOME:-~/.i3}/bin/dmenu_ssh "urxvtc -e ssh -X" -i -p ssh -fn "M4_I3_DMENU_FONT" -nb "M4_I3_BG" -nf "M4_COLOR_FG" -sb "M4_COLOR_4" -sf "M4_I3_ACTIVE_FG"
